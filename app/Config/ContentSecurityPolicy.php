...
class ContentSecurityPolicy extends BaseConfig
{
     ...
     */
    public $scriptSrc = ['self', "'unsafe-inline'", 'https://cdn.tailwindcss.com', 'https://code.jquery.com', 'https://cdnjs.cloudflare.com', 'https://unpkg.com'];
     ...
     * @var list<string>|string
     */
    public array|string $scriptSrcElem = ['self', "'unsafe-inline'", 'https://cdn.tailwindcss.com', 'https://code.jquery.com', 'https://cdnjs.cloudflare.com', 'https://unpkg.com'];
